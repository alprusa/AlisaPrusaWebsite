...
public class Sudoku_Board extends PApplet {
...
// Single Rectangle
public void cell(int x, int y, int s, int tinto) {
  fill(tinto);
  rect(x, y, s, s);
}

// Three Regtangles in a Across
public void triple(int x, int y, int s, int tinto) {
...
public void block(int x, int y, int s, int tinto) {
...
public void row(int x, int y, int s, int tinto) {
...
// 81 Rectangles
public void cellarray(int x, int y, int s, int tinto) {
...
// Create Parimeter
public void board(int x, int y, int s, int tinto) {
...
public void mousePressed() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "Sudoku_Board" });
  }
}
