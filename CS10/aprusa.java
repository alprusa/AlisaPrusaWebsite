...
public class aprusa extends PApplet {

int look=0; // Position of Eyes
int dir=0; // Position of Blinky
int blinkycolor =  color(255, 0, 0); // Color of Blinky
...
// Change Blinky's Color by Click
 public void mousePressed() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "aprusa" });
  }
}
